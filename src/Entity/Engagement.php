...
class Engagement
{
    ...
    #[ORM\OneToMany(targetEntity: Quote::class, mappedBy: 'engagement',
        cascade: ['persist', 'remove'], orphanRemoval: true)]
    private Collection $quotes;

    #[ORM\ManyToOne(targetEntity: Quote::class)]
    #[ORM\JoinColumn(name: 'chosen_quote_id', referencedColumnName: 'id',
    ...
    #[ORM\OneToMany(targetEntity: Image::class, mappedBy: 'engagement',
        cascade: ['persist', 'remove'], orphanRemoval: true)]
    ...
    {
        return $this->quotes->filter(fn(Quote $quote) => $quote->getStatus() === QuoteStatusEnum::SUBMITTED);
    }
    ...
    {
        return $this->quotes->exists(fn(int $key, Quote $quote) => $quote->getOwner()->getId() === $user->getId());
    }
    ...
    {
       return $this->payments->findFirst(fn(int $key, Payment $payment) => $payment->getType() === PaymentTypeEnum::POSTING_FEE);
    }
