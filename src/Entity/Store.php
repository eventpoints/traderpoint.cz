...
class Store
{
    ...
    /** Short code the cashier can type (4–8 chars), unique across all stores. */
    ...
    public function __construct(Partner $partner, string $name, string $slug, string $code)
    {
    ...
    #[ORM\PreUpdate]
    public function touch(): void { $this->updatedAt = CarbonImmutable::now(); }
