...
return array(
    ...
    'landing.skill.skill.builder' => 'I need a Builder',
    'landing.skill.skill.electrician' => 'I need an Electrician',
    'landing.skill.skill.plumber' => 'I need a Plumber',
    ...
    'engagement.status.under-review' => 'Under Review',
    'engagement.status.receiving-quotes' => 'Receiving Quotes',
    'engagement.status.quote-accepted' => 'Quote Accepted',
    'engagement.status.in-progress' => 'In Progress',
    'engagement.status.issue-resolution' => 'Issue Resolution',
    'engagement.status.work-completed' => 'Work Completed',
    'engagement.status.awaiting-review' => 'Awaiting Review',
    'engagement.status.reviewed' => 'Reviewed',
    'engagement.status.rejected' => 'Rejected',
    'engagement.status.cancelled' => 'Cancelled',
